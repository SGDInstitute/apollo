...
bard:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ', which details what we''re requesting as part of the RFQ, and breaks out the specs and timeline for the project. Please carefully read the RFQ, and get in touch with Nick Pfost (nick@sgdinstitute.org), the Institute''s director of marketing and communications, if you have any questions.'
  -
    type: set
    attrs:
      values:
