...
bard:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Once upon a time, our team had a dream to launch a podcast to extend our focus on Midwest queer and trans communities—and, like others, we thought '
      -
        type: text
        marks:
          -
            type: italic
        text: 'what better time to do that than during a pandemic, when our connections to each other and the nourishing conversations we have in physical space was deeply impacted.'
  -
    type: paragraph
    content:
      -
