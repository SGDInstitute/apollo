...
bard:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Later this year, we’ll be launching a message board for conference attendees to connect with other attendees to connect about arranging shared travel.'
  -
    type: paragraph
    attrs:
      textAlign: left
