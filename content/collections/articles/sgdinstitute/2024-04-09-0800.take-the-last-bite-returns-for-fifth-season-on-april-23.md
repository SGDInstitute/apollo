...
bard:
  ...
  -
    ...
    content:
      -
        type: text
        text: "Summer is coming, and we're headed to the potluck. There is A LOT to unpack here, so join us in laying it all out on the fold-up banquet table, dishing up, and—most importantly—taking each and every last bite."
  -
    type: paragraph
    attrs:
      textAlign: left
